...
const navItems: {
  ...
  { href: "/lab-results", label: "Lab Inbox", icon: FlaskConical, roles: ["admin", "veterinarian", "technician"] },
  { href: "/care-reminders", label: "Care Reminders", icon: HeartPulse, roles: ["admin", "veterinarian", "technician", "front_desk"] },
  ...
  { href: "/vetclaw", label: "VetClaw", icon: Stethoscope, roles: ["admin", "veterinarian"] },
  { href: "/recalls", label: "Recalls", icon: Bell, roles: ["admin", "veterinarian"] },
